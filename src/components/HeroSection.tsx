...
/>
      ...
      <div className="absolute left-4 md:left-[140px] bottom-[80px] md:bottom-auto md:top-[298px] w-[calc(100%-32px)] md:w-[635px]">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-8 h-11 md:h-[52px] md:w-[230px] bg-[#961200] rounded-full text-[#FDFDFD] font-semibold text-sm md:text-base"
          >
            Watch Trailer
        <img 
      src={play_button} 
    ...
    />
          ...
          <button
            onClick={() => navigate(`/movie/${featuredMovie.id}`)}
            className="flex items-center justify-center gap-2 px-8 h-11 md:h-[52px] md:w-[230px] bg-[rgba(10,13,18,0.6)] border border-[#181D27] backdrop-blur-[20px] rounded-full text-[#FDFDFD] font-semibold text-sm md:text-base"
          >
            See Detail
          </button>
        </div>
